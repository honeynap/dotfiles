...
static const char *cmdslock[]  = { "slock", NULL };
...
static const char *cmdsoundup[]  = { "pamixer", "-i", "10", NULL };
static const char *cmdsounddown[]  = { "pamixer", "-d", "10", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Escape, spawn,          {.v = cmdslock } },
	{ MODKEY|ShiftMask,             XK_t,      spawn,          {.v = tmuxcmd } },
	{ MODKEY|ShiftMask,             XK_g,      spawn,          {.v = cmdchrome } },
